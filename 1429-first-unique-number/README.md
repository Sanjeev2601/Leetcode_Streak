<h2><a href="https://leetcode.com/problems/first-unique-number/">1429. First Unique Number</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>You have a queue of integers, you need to retrieve the first unique integer in the queue.</p>
